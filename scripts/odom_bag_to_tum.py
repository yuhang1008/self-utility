...
for sequence_num in range(11):
    ...
    for a_odometry in df_odometry.values:
        ...
        Rcw0 = Tcw0[:3, :3]
        rotation = R.from_matrix(Rcw0)
        quat_cw0 = rotation.as_quat()
        
        cali_time = a_odometry[2] + a_odometry[3]/1000000000
        
        tum_string.append(str("{:.4f}".format(cali_time)))
        tum_string.append(str("{:.4f}".format(Tcw0[0][3])))
        tum_string.append(str("{:.4f}".format(Tcw0[1][3])))
        tum_string.append(str("{:.4f}".format(Tcw0[2][3])))
        tum_string.append(str("{:.4f}".format(quat_cw0[0])))
        tum_string.append(str("{:.4f}".format(quat_cw0[1])))
        tum_string.append(str("{:.4f}".format(quat_cw0[2])))
        tum_string.append(str("{:.4f}".format(quat_cw0[3])))
